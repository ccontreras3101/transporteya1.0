 ...
 */
class Cliente2 extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['rut', 'rut_add', 'nombre', 'direccion', 'fono', 'email', 'reglas_condiciones', 'username', 'password', 'comuna_id', 'tipo', 'foto_perfil','imagen_perfil', 'roll_sii'],"safe"],
            ...
            [['foto_perfil','imagen_perfil', 'roll_sii'], 'file', 'extensions' => 'jpg, png', 'skipOnEmpty' => true],
            [['rut', 'rut_add'], 'rutvalidate'],
            [['rut'], 'rutunico'],
            [['rut', 'rut_add','nombre','direccion','fono','email','username','password','comuna_id'], 'required'],
        ];
    }
