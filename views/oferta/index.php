...
?>
    ...
    <?php } ?>
        ...
        <h4 style="color: #379e2c; ">Para más información sobre la empresa presione sobre el nombre.</h4>
        <?= GridView::widget([
                    ...
                    'view' => function ($url, $model) 
                        ...
                        'link' => function ($url, $model) {
                            if( Yii::$app->user->can('empresa') && $model->pedido->status != 1 ){
                                ...
                                ['/oferta/create', 'cliente_id' => $model->cliente_id, 'pedido_id'=>$model->pedido_id],
